		...
		<div class="container">
			...
			<div class="content">
				...
				<div class="span-12 midcol">
					<h3>Our Apologies</h3>
					<p>
						We do not have a record of any quotation sent to you. If you have arrived at this page
						by clicking a link sent to you in an email, please get in touch with the person you
						were corresponding with and inform him of this message. 
					</p>
					<p>
						In the meanwhile, feel free to browse our <a href="<!-- TMPL_VAR NAME=BASEPREFIX -->tours">Tours</a>, 
						<a href="<!-- TMPL_VAR NAME=BASEPREFIX -->modules">Modules</a>, <a href="<!-- TMPL_VAR NAME=BASEPREFIX -->special_places">Special Places</a>
						and <a href="<!-- TMPL_VAR NAME=BASEPREFIX -->themes">Themes</a>.
					</p>
				</div>
