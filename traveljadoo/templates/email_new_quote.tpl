...
<html>
    <head>
        ...
        <meta property="og:title" content="<!-- TMPL_VAR NAME=subject -->" />
        
        <title><!-- TMPL_VAR NAME=subject --></title>
		<style type="text/css">
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="cid:tpcom_header" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                <strong>Dear <!-- TMPL_VAR NAME=lead -->,</strong><br />
                                                                Thank you for making an enquiry through <strong>Traveller's Palm</strong>. We value your business and look forward to assisting you. Please find  our quotation for your tour:
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              <tr>
                                                                  ...
                                                                  <th scope="col" valign="top" width="15%" class="dataTableHeading" mc:edit="data_table_heading01">
                                                                    Currency
                                                                  </th>
                                                              ...
                                                              <tr mc:repeatable>
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                  	<!-- TMPL_VAR NAME=pax --> Travellers @ <!-- TMPL_VAR NAME=ratepp -->
                                                                  </td>
                                                                  ...
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content02">
                                                                    <!-- TMPL_VAR NAME=touramt -->
                                                                  </td>
                                                              </tr>
                                                              <tr mc:repeatable>
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                  	Service Tax @ <!-- TMPL_VAR NAME=taxpc -->%
                                                                  </td>
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content01">
                                                                  	<!-- TMPL_VAR NAME=currency -->
                                                                  </td>
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            ...
                                                            <!-- TMPL_IF NAME=is_advance -->
															The balance of the holiday cost <b><!-- TMPL_VAR NAME=currency --> <!-- TMPL_VAR NAME=balamt --></b> must be paid to us before <!-- TMPL_VAR NAME=baldate -->. A reminder will be sent to you a week before the balance payment is due.
															<!-- TMPL_ELSE -->
															Full payment is required as your booking is within 3 calendar months prior to the start of your holiday.
															<!-- /TMPL_IF -->
                                                            </div>
														</td>
                                                    </tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="<!-- TMPL_VAR NAME=payurl -->" target="_blank">Click here to view your itinerary and make the payment due now.</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2013 Odyssey Tours and Travels, All rights reserved.</em>
																<br />
																<strong style="color: red;">Please do not reply to this email. It has been sent by an automated booking system from an address that is not monitored.</strong>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
