...
<html>
	<head>
		...
		<title>
			...
			<!-- TMPL_ELSE -->
				Heritage Hotels | Traveller's Palm - Custom Tours to India
			<!-- /TMPL_IF -->
		</title>
	</head>
	<body>
		<div class="container">
			...
			<div class="span-24 last">
				<img src="<!-- TMPL_VAR NAME=BASEPREFIX -->images/banners/banner_heritagehotels.jpg" width="950" height="150" alt="Collage"/>
			</div>
			<hr class="space" />
			<div class="content">
					...
					<ul>
						...
						<li><a href="<!-- TMPL_VAR NAME=BASEPREFIX -->special_places">Special Places</a>
							<ul>
								...
								<li><div id="current"> &raquo; Heritage Hotels</div></li>
