		...
		<div class="container">
			...
			<div class="span-16">
				<div id="imgframe">
					<div id="frameslideshow" thiscity="<!-- TMPL_VAR NAME=CITYID -->" maxcityimages="<!-- TMPL_VAR NAME=NUMIMAGES -->">
						<img src="/images/city/city_<!-- TMPL_VAR NAME=CITYID -->_large_1.jpg" width="560" height="340" alt="" title="" imgsrno = "1" imgfile="city_<!-- TMPL_VAR NAME=CITYID -->_large_1.jpg" />
						<img src="/images/city/city_<!-- TMPL_VAR NAME=CITYID -->_large_2.jpg" width="560" height="340" alt="" title="" imgsrno = "2" imgfile="city_<!-- TMPL_VAR NAME=CITYID -->_large_2.jpg" />
					</div>
				</div>
			</div>
			...
			<div class="content">
				...
				<!-- TMPL_IF NAME=CITYTYPE -->
					...
					<ul>
						...
						<li><a  id="toplink" href="/special_places">Special Places</a>
							<ul>
								<li><a id="midlink" href="/state/<!-- TMPL_VAR NAME=STATEURL -->"><!-- TMPL_VAR NAME=STATENAME --></a>
									<ul>
										<li><div id="current"><!-- TMPL_VAR NAME=CITYNAME --></div></li>
										<!-- TMPL_LOOP NAME=OTHERCITIES -->
										<li><a href="/city/<!-- TMPL_VAR NAME=OTHERCITYURL -->"><!-- TMPL_VAR NAME=OTHERCITYNAME --></a></li>
										<!-- /TMPL_LOOP -->
									</ul>
								</li>
							</ul>
				...
				<div class="span-12 midcol">
					...
					<p class="hotelcatnotice">'$' Signs against Hotels indicate its <a href="/hotel.cgi?mode=minihoteltypes&height=500&width=400" title="Hotel Categories" class="thickbox">Category</a></p>
					...
					<p class="imgholder"><a href="/hotel/<!-- TMPL_VAR NAME=HOTELURL -->"><img class="left" src="/images/hotel/defaulthotel_<!-- TMPL_VAR NAME=HOTELID -->.jpg" width="220" height="150" /></a></p>
					<a href="/hotel/<!-- TMPL_VAR NAME=HOTELURL -->"><h4><!-- TMPL_VAR NAME=HOTELNAME --> ($)</h4></a>
					<p class="hansbold"><!-- TMPL_VAR NAME=HOTELWRITEUP --></p>
					<p><a class="hotellink" href="/hotel/<!-- TMPL_VAR NAME=HOTELURL -->">Read More &raquo;</a></p>
					<hr />
					<!-- /TMPL_LOOP -->
					...
					<img src="/images/city/city_<!-- TMPL_VAR NAME=CITYID -->_collage.gif" width="470" height="514" />
				...
				<!-- TMPL_IF NAME=CITYTYPE -->
					...
					<p class="box"><!-- TMPL_VAR NAME=MODTEXT --><br /><a href="region.cgi">Explore our Modules</a></p>
					<!-- /TMPL_UNLESS -->
					<!-- /TMPL_IF -->
