<div class="hotelimages">
	<img src="images/hotel_<!-- TMPL_VAR NAME=HOTELID -->_collage_1.jpg" width="590" height="160" alt="Image Not Available" />
</div>
<div class="overview">
	<div class="summary">
		&nbsp;
...
<div class="accommodation">
	<p><img src="images/hotel_<!-- TMPL_VAR NAME=HOTELID -->_collage_2.jpg" width="590" height="160" alt="Image Not Available" /></p>
	<div class="summary">
		&nbsp;
	</div>	
	<div class="detail">
