			...
			<div class="span-16">
				<div id="imgframe">
					<div id="frameslideshow" itintypedir="<!-- TMPL_VAR NAME=ITINTYPEDIR -->" itintype="<!-- TMPL_VAR NAME=ITINTYPE -->" thisitin="<!-- TMPL_VAR NAME=ITINID -->" maxitinimages="<!-- TMPL_VAR NAME=NUMIMAGES -->">
						<img src="/images/<!-- TMPL_VAR NAME=ITINTYPEDIR -->/<!-- TMPL_VAR NAME=ITINTYPE -->_<!-- TMPL_VAR NAME=ITINID -->_1.jpg" width="560" height="340" alt="" title="" imgsrno="1" imgfile="<!-- TMPL_VAR NAME=ITINTYPE -->_<!-- TMPL_VAR NAME=ITINID -->_1.jpg" />
						<img src="/images/<!-- TMPL_VAR NAME=ITINTYPEDIR -->/<!-- TMPL_VAR NAME=ITINTYPE -->_<!-- TMPL_VAR NAME=ITINID -->_2.jpg" width="560" height="340" alt="" title="" imgsrno="2" imgfile="<!-- TMPL_VAR NAME=ITINTYPE -->_<!-- TMPL_VAR NAME=ITINID -->_2.jpg" />
					</div>
				</div>
			</div>
			...
			<div class="content">
				<div class="span-4 leftcol">
					...
					<ul>
						...
						<li><a <!-- TMPL_IF NAME=REGIONID -->id="toplink"<!-- /TMPL_IF --> href="/modules">Mini Itineraries</a>
							<!-- TMPL_IF NAME=REGIONID -->
							<ul>
								<li><a id="midlink" href="/modules/<!-- TMPL_VAR NAME=REGIONURL -->"><!-- TMPL_VAR NAME=REGIONNAME --></a>
									<ul>
										<li><div id="current"><!-- TMPL_VAR NAME=ITINNAME --></div></li>
										<!-- TMPL_LOOP NAME=OTHERITINS -->
										<li><a href="/moduledetails/<!-- TMPL_VAR NAME=OTHERITINURL -->"><!-- TMPL_VAR NAME=OTHERITINNAME --></a></li>
										<!-- /TMPL_LOOP -->
									</ul>
								</li>
							</ul>
						...
						<li><a <!-- TMPL_UNLESS NAME=REGIONID -->id="toplink"<!-- /TMPL_UNLESS --> href="/tours">Indian Journeys</a>
				...
				<div class="span-12 midcol">
					...
					<img src="/images/<!-- TMPL_VAR NAME=ITINTYPEDIR -->/<!-- TMPL_VAR NAME=ITINTYPE -->_<!-- TMPL_VAR NAME=ITINID -->_collage_1.jpg" width="470" height="180" />
					...
					<img src="/images/<!-- TMPL_VAR NAME=ITINTYPEDIR -->/<!-- TMPL_VAR NAME=ITINTYPE -->_<!-- TMPL_VAR NAME=ITINID -->_collage_2.jpg" width="470" height="180" />
					<p class="fav">
				...
				<div class="span-8 rightcol last">
					<!-- TMPL_IF NAME=ITINISTOUR -->
					<h3>Tour Route</h3>
					<p style="padding-left: 20px;"><img src="/images/tours/rt_map_<!-- TMPL_VAR NAME=ITINID -->.jpg" height="245" width="269" /></p>
					<!-- TMPL_ELSE -->
					...
					<div class="box">
						<img class="left" src="/images/modules/mod_<!-- TMPL_VAR NAME=ITINID -->_tip_<!-- TMPL_VAR NAME=__counter__ -->.gif" width="114" height="114" />
