...
<html>
	<head>
		...
		<link rel="stylesheet" href="css/tp_home.css" type="text/css" media="screen, projection">
		<link rel="stylesheet" href="css/ch_odyssey.css" type="text/css" media="screen, projection">
		<script type="text/javascript" src="js/jquery-1.4.2.min.js"></script>
		<script type="text/javascript" src="js/jquery.cycle.min.js"></script>
		<script type="text/javascript" src="js/new_hpage.js"></script>
	...
	<body>
		<div class="container">
			...
			<div class="span-16">
				<div id="imgstack">
					<div id="slideshow" maxhomeimages="<!-- TMPL_VAR NAME=MAXHOMEIMAGES -->">
						<img src="/images/home/hp_1.jpg" width="560" height="325" alt="1" />
						<img src="/images/home/hp_2.jpg" width="560" height="325" alt="2" />
					</div>
				</div>
			</div>
			...
			<div class="span-16 tagline">
				<img src="/images/home/tailormade.jpg" width="630" height="60" alt="Tailormade Holidays in India" />
			</div>
			<div class="span-8 last">
			...
			<div class="content">
				...
				<div class="span-12 midcol">
					<h3><a href="/themes"><!-- TMPL_VAR NAME=DISCOVERTITLE --></a></h3>
					<a href="/themes"><img src="/images/home/home_collage_1.jpg" width="470" height="180" style="margin-bottom: 10px;" /></a>
					<!-- TMPL_VAR NAME=DISCOVERBODY -->
					<h3><a href="/special_places"><!-- TMPL_VAR NAME=CHECKOUTTITLE --></a></h3>
					<a href="/special_places"><img src="/images/home/home_collage_2.jpg" width="470" height="180" style="margin-bottom: 10px;" /></a>
					<!-- TMPL_VAR NAME=CHECKOUTBODY -->
					<h3><a href="/modules"><!-- TMPL_VAR NAME=INSPIRATIONTITLE --></a></h3>
					<a href="/modules"><img src="/images/home/home_collage_3.jpg" width="470" height="180" style="margin-bottom: 10px;" /></a>
					<!-- TMPL_VAR NAME=INSPIRATIONBODY -->
					<h3><a href="/tours"><!-- TMPL_VAR NAME=FOLLOWTITLE --></a></h3>
					<a href="/tours"><img src="/images/home/home_collage_4.jpg" width="470" height="180" style="margin-bottom: 10px;" /></a>
					<!-- TMPL_VAR NAME=FOLLOWBODY -->
				</div>
				<div class="span-8 rightcol last">
					<h3><a href="/why-travel-with-us"><!-- TMPL_VAR NAME=RT1TITLE --></a></h3>
					<a href="/why-travel-with-us"><img src="/images/home/homepage_advert_1.gif" class="left" width="114" height="114" style="float: left; padding-top: 10px;" /></a>
					<div class="box" style="background: #e6e2df; width: 170px; clear: none;"><!-- TMPL_VAR NAME=RT1BODY --></div>
					<h3><a href="/tourdetails/frontiers-of-india"><!-- TMPL_VAR NAME=RT2TITLE --></a></h3>
					<a href="/tourdetails/frontiers-of-india"><img src="/images/home/homepage_advert_2.gif" class="left" width="114" height="114" style="float: left; padding-top: 10px;" /></a>
					<div class="box" style="background: #e6e2df; width: 170px; clear: none;"><!-- TMPL_VAR NAME=RT2BODY --></div>
					<h3><!-- TMPL_VAR NAME=RT3TITLE --></h3>
					<img src="/images/home/homepage_advert_3.gif" class="left" width="114" height="114" style="float: left; padding-top: 10px;" />
					...
					<a href="http://solita.co.in"><img src="/images/home/homepage_advert_4.gif" class="left" width="114" height="114" style="float: left; padding-top: 10px;" /></a>
					...
					<a href="http://solita.co.in"><img src="/images/home/homepage_stoppress.gif" class="left" width="114" height="114" style="float: left; padding-top: 10px;" /></a>
					...
					<img src="/images/home/homepage_advert_5.gif" class="left" width="114" height="114" style="float: left; padding-top: 10px;" />
