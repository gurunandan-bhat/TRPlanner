			...
			<div class="content">
				<div class="span-4 leftcol">
					...
					<ul>
						...
						<li><a id="toplink" href="/special_places">Special Places</a></li>
				...
				<div class="span-12 midcol">
					...
					<div class="vheaderbox">
						<a href="/state/<!-- TMPL_VAR NAME=STATEURL -->"><h4 class="listmods"><!-- TMPL_VAR NAME=STATE --></h4></a>
						<h5 class="listmods"><!-- TMPL_VAR NAME=STATEONELINER --></h5>
					</div>
					<p>
						<a href="/state/<!-- TMPL_VAR NAME=STATEURL -->"><img src="/images/state/state_<!-- TMPL_VAR NAME=STATEID -->_small.jpg" width="220" height="151" class="left" /></a>
				...
				<div class="span-8 rightcol last">
					...
					<div class="box">
						<img class="left" src="/images/fairs/fair_<!-- TMPL_VAR NAME=FAIRID -->.gif" width="114" height="114" />
