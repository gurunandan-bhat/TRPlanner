			...
			<div class="content-leftsided">
				<div class="span-4 leftcol">
					...
					<ul>
						...
						<li><a id="toplink" href="/about-us">About Us</a>
							<ul>
				...
				<div class="span-12 midcol">
					<div class="people">
						...
						<p><img class="left" src="images/consultants/consultant_<!-- TMPL_VAR NAME=ID -->.jpg" width="240" height="150" alt="<!-- TMPL_VAR NAME=NAME -->" /></p>
