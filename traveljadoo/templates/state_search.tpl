		...
		<div class="container">
			...
			<div class="span-16">
				<div id="imgframe">
					<div id="frameslideshow">
						<img src="/images/state/state_<!-- TMPL_VAR NAME=STATEID -->_main.jpg" width="560" height="340" />
					</div>
				</div>
			</div>
			...
			<div class="content">
				...
				<div class="span-12 midcol">
					...
					<img src="/images/state/state_<!-- TMPL_VAR NAME=STATEID -->_large_1.jpg" width="470" height="180" />
				</div>
