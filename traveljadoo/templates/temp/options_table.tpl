<div id="firstoption">
	<h1><input type="radio" name="travelopts" value="1" checked="checked" /> <!-- TMPL_VAR NAME=HDR1 --></h1>
	<table width="98%">
		<tr>
...
<div id="otheroptions">
	<div>
		<h1><input type="radio" name="travelopts" value="2" /> <!-- TMPL_VAR NAME=HDR2 --></h1>
		<table width="98%">
			<tr>
				<th>From</th><th>Departure</th><th>To</th><th>Arrival</th>		
			</tr>
	...
	<div>
		<h1><input type="radio" name="travelopts" value="3" /> <!-- TMPL_VAR NAME=HDR3 --></h1>
		<table width="98%">
			<tr>
				<th>From</th><th>Departure</th><th>To</th><th>Arrival</th>		
			</tr>
