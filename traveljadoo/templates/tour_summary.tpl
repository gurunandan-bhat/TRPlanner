...
<table width="98%" class="bordered">
	...
	<tr class="summaryrow<!-- TMPL_UNLESS NAME=__odd__ --> even<!-- /TMPL_UNLESS -->">
		<td width="14" class="indicator"><img src="images/style/openup.gif" width="16" height="16" /></td>
	...
	<tr class="summarydetail">
		<td colspan="5">
			...
			<p><img src="<!-- TMPL_VAR NAME=BASEPREFIX -->images/movingon/city_<!-- TMPL_VAR NAME=CITYID -->_movingon.jpg" height="63" width="100" />
