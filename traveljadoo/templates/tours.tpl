...
<html>
	...
	<body>
		<div class="container">
			...
			<div class="span-24 last">
				<img src="/images/itineraries_large.jpg" width="950" height="150" alt="Collage"/>
			</div>
			<hr class="space" />
			<div class="content">
				...
				<div class="span-12 midcol">
					...
					<p>
						...
						<!-- /TMPL_IF -->
						Page: <!-- TMPL_IF NAME=FIRSTPAGE --> 1 | <a href="/tours/2">2 &raquo;</a> <!-- TMPL_ELSE --> <a href="/tours/1">&laquo; 1</a> | 2<!-- /TMPL_IF -->
					</p>
					...
					<p>
						<a href="/tourdetails/<!-- TMPL_VAR NAME=TOURURL -->"><img src="/images/rt_<!-- TMPL_VAR NAME=TOURID -->_small.jpg" width="220" height="151" class="left" /></a>
