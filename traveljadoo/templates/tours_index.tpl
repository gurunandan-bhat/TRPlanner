			...
			<div class="span-8 writeup last">
				<div id="writeup">
					...
					<p><strong>
						...
						Click <!-- TMPL_IF NAME=FIRSTPAGE --><a href="<!-- TMPL_VAR NAME=BASEPREFIX -->tours/2">Page 2</a> <!-- TMPL_ELSE --><a href="<!-- TMPL_VAR NAME=BASEPREFIX -->tours/">Page 1</a><!-- /TMPL_IF --> for more.
					</strong></p>
				</div>
			</div>
			<hr class="space" />
