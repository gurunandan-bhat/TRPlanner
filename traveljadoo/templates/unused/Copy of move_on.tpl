		...
		<div class="container">
			...
			<div class="column span-24 last city">
				...
				<div class="column span-8 last description">
					<h1><!-- TMPL_VAR NAME=CURRNAME --></h1>
					<h2><!-- TMPL_VAR NAME=CURRONELINER --></h2>
					<p><!-- TMPL_VAR NAME=CURRWRITEUP --></p>
				</div>
			</div>
			<div class="column span-16">
				<div class="moveon">
					...
					<div class="option">					
						<h1>Other Places</h1>
						<p>You can choose to go to any other city by selecting from the various options listed.</p>
						...
						<div id="map"><img src="images/dead_map.png" width="500" height="350" /></div>
					</div>
				</div>
			</div>
			<div class="column span-8 last self">
				<div class="mapcontainer">
					<!-- TMPL_IF NAME=SUMMARY -->
						...
						On the left, we have listed the <strong>most popular destinations from <!-- TMPL_VAR NAME=CURRNAME --></strong>	with a note on what makes each of them special.</p>
