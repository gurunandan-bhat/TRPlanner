			...
			<div class="span-16">
				<div class="moveon">
					...
					<!-- TMPL_IF NAME=MODHOTELS -->
						...
						<div class="brief">
							<div class="span-3"><h2><!-- TMPL_VAR NAME=HOTELNAME --></h2></div>
							<div class="span-4"><img src="images/defaulthotel_<!-- TMPL_VAR NAME=HOTELID -->_left.jpg" width="120" height="83" alt="HotelImage" /></div>
							<div class="span-1">$</div>
							<div class="span-8 last"><!-- TMPL_VAR NAME=HOTELDESCRIPTIONSMALL --></div>
						</div>
						<p class="toggler"><a href="#">Toggle Details</a></p>
						<div class="span-16 last detail">
